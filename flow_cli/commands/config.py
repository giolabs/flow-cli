...
def config_command(set_value: Optional[str], get_key: Optional[str], list_config: bool, 
                  init: bool, reset: bool) -> None:
    """
...
def validate_flutter_sdk(path: str) -> bool:
    ...
    return (
        flutter_path.exists() and
        (flutter_path / "bin/flutter").exists()
    )
...
def validate_android_sdk(path: str) -> bool:
    ...
    return (
        android_path.exists() and
        (android_path / "platform-tools").exists()
    )
...
def validate_xcode(path: str) -> bool:
    ...
    return (
        xcode_path.exists() and
        xcode_path.name.endswith('.app') and
        (xcode_path / "Contents/Developer").exists()
    )
