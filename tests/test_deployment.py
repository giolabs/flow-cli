...
class TestDeploymentSetup:
    ...
    def test_setup_fastlane_success(self, cli_runner, mock_flutter_project_with_git, mock_inquirer_prompt, mock_subprocess_run):
        ...
        with patch('flow_cli.core.flutter.FlutterProject.find_project') as mock_find:
            mock_find.return_value = Mock(
                path=mock_flutter_project_with_git,
                name="test_project"
            )
    ...
    def test_setup_creates_feature_branch(self, cli_runner, mock_flutter_project_with_git, mock_inquirer_prompt, mock_subprocess_run):
        ...
        with patch('flow_cli.core.flutter.FlutterProject.find_project') as mock_find:
            ...
            git_calls = [call for call in mock_subprocess_run.call_args_list 
                        if 'git' in str(call)]
            
            assert any('checkout -b feature/fastlane-setup' in str(call) for call in git_calls)
            assert_command_success(result)
    
    def test_setup_skip_branch_flag(self, cli_runner, mock_flutter_project_with_git, mock_inquirer_prompt, mock_subprocess_run):
    ...
    def test_setup_force_flag(self, cli_runner, mock_flutter_project_with_git, mock_inquirer_prompt, mock_subprocess_run):
    ...
    def test_setup_prerequisites_check(self, cli_runner, mock_flutter_project_with_git, mock_subprocess_run):
    ...
    def test_setup_generates_gemfile(self, cli_runner, mock_flutter_project_with_git, mock_inquirer_prompt, mock_subprocess_run):
...
class TestKeystoreGeneration:
    ...
    def test_keystore_android_generation(self, cli_runner, mock_flutter_project, mock_inquirer_prompt, mock_subprocess_run):
        ...
        with patch('flow_cli.core.flutter.FlutterProject.find_project') as mock_find:
            ...
            keytool_calls = [call for call in mock_subprocess_run.call_args_list 
                           if 'keytool' in str(call)]
            assert len(keytool_calls) > 0
            assert_command_success(result)
    
    def test_keystore_ios_generation_macos(self, cli_runner, mock_flutter_project, mock_inquirer_prompt):
    ...
    def test_keystore_ios_generation_non_macos(self, cli_runner, mock_flutter_project, mock_inquirer_prompt):
    ...
    def test_keystore_force_regeneration(self, cli_runner, mock_flutter_project, mock_inquirer_prompt, mock_subprocess_run):
    ...
    def test_keystore_security_gitignore(self, cli_runner, mock_flutter_project, mock_inquirer_prompt, mock_subprocess_run):
...
class TestReleaseCommand:
    ...
    def test_release_android_build_only(self, cli_runner, mock_flutter_project, mock_inquirer_prompt, mock_subprocess_run):
        ...
        with patch('flow_cli.core.flutter.FlutterProject.find_project') as mock_find:
            ...
            flutter_calls = [call for call in mock_subprocess_run.call_args_list 
                           if 'flutter' in str(call)]
            assert any('build appbundle' in str(call) for call in flutter_calls)
            assert_command_success(result)
    
    def test_release_with_tests(self, cli_runner, mock_flutter_project, mock_inquirer_prompt, mock_subprocess_run):
        ...
        with patch('flow_cli.core.flutter.FlutterProject.find_project') as mock_find:
            ...
            test_calls = [call for call in mock_subprocess_run.call_args_list 
                         if 'flutter test' in str(call)]
            assert len(test_calls) > 0
            assert_command_success(result)
    
    def test_release_version_increment(self, cli_runner, mock_flutter_project, mock_inquirer_prompt, mock_subprocess_run):
...
""")
    ...
    def test_release_flavor_support(self, cli_runner, mock_flutter_project, mock_inquirer_prompt, mock_subprocess_run):
...
class TestDeploymentIntegration:
    ...
    def test_complete_deployment_workflow(self, cli_runner, mock_flutter_project_with_git, mock_inquirer_prompt, mock_subprocess_run):
        ...
        with patch('flow_cli.core.flutter.FlutterProject.find_project') as mock_find:
            ...
            # 4. Release
            result_release = cli_runner.invoke(release_command, ['--platform', 'android', '--build-only'])
